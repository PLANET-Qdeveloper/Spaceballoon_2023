#ライブラリのインポート
from machine import Pin, UART, I2C, SPI, lightsleep, Timer
import time, os
...
# LEDピンの初期化
led1 = machine.Pin(LED_PIN, machine.Pin.OUT)
led1.value(0)
...
os.mount(sd, '/sd')
file_index = 1
file_name = '/sd/PQ_BALLOON'+str(file_index)+'.csv'
init_sd_time = 0
while True:
    try:
...
file.write("TIME,PRESSURE,TEMPERATURE,LATITUDE,LONGITUDE\r\n")
...
def record(t):
    ...
    file.write("%d,%f,%f,%f,%f\r\n"%(flight_time, PRESS, TEMP, lat, lon))
